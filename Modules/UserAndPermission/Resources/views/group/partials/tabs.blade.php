@php
    ...
    $readOnly = $routeName == 'userandpermission.group.show';
    $selectAllUsers ??= null;
...
<ul class="nav nav-tabs" id="content-tab" role="tablist">
    <li class="nav-item">
        ...
        role="tab" aria-controls="content-group" aria-selected="true">@lang('Users')</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content" id="content-tabContent">
    <div class="tab-pane fade show active" id="content-group" role="tabpanel" aria-labelledby="content-group-tab">
        @include('userandpermission::group.partials.list-users', compact('list_users', 'readOnly', 'color', 'selectAllUsers'))
    </div>
